...
<!--mobile-->
        ...
        <li class="subtitled rf-normal">Regulations & Forms</li><li class="subtitled rf-checked2">Borrowing Meeting Room(s)</li>
        </ul>
        ...
        <div class="rf-form_list_block mobilehidden">
			...
			<?php 
				$evaluation = get_category_by_slug('en-evaluation');
			...
			<?php 
				$employment_and_establishment = get_category_by_slug('en-employment_and_establishment');
			...
			<?php 
				$others = get_category_by_slug('en-others');
			...
			<?php 
				$forms_for_promotion = get_category_by_slug('en-forms_for_promotion');
			...
			<?php 
				$self_evaluation_form = get_category_by_slug('en-self-evaluation_form');
			...
			<?php 
				$forms_for_external_review = get_category_by_slug('en-forms_for_external_review');
...
$i=0;
$b1_page=0;
$args = array('category_name' => 'en-promotion','order'=>'ASC');
...
$i=0;
$b2_page=0;
$args = array('category_name' => 'en-evaluation','order'=>'ASC');
$the_query = new WP_Query($args);
//echo $the_query->max_num_pages;
if($the_query->have_posts()):
?>
...
$i=0;
$b3_page=0;
$args = array('category_name' => 'en-employment_and_establishment','order'=>'ASC');
$the_query = new WP_Query($args);
//echo $the_query->max_num_pages;
if($the_query->have_posts()):
?>
...
$i=0;
$b4_page=0;
$args = array('category_name' => 'en-others','order'=>'ASC');
$the_query = new WP_Query($args);
//echo $the_query->max_num_pages;
if($the_query->have_posts()):
?>
...
$i=0;
$b5_page=0;
$args = array('category_name' => 'en-forms_for_promotion','order'=>'ASC');
$the_query = new WP_Query($args);
//echo $the_query->max_num_pages;
if($the_query->have_posts()):
?>
...
$i=0;
$b6_page=0;
$args = array('category_name' => 'en-self-evaluation_form','order'=>'ASC');
$the_query = new WP_Query($args);
//echo $the_query->max_num_pages;
if($the_query->have_posts()):
?>
...
$i=0;
$b7_page=0;
$args = array('category_name' => 'en-forms_for_external_review','order'=>'ASC');
$the_query = new WP_Query($args);
//echo $the_query->max_num_pages;
if($the_query->have_posts()):
?>
