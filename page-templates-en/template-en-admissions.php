...
<div class="page-admissions">
    ...
    <div class="container">
	    ...
	    <div class="subtitled adm-l_title">Admissions</div>
        <div class="adm-container-mobile">
            <div class="subtitle adm-b_title">Application</div>
          ...
          <div class="adm-block-container mobilehidden"> <!--AnnieDisplayNone-->  
            <div class="adm-block1">
                <div class="adm-block_r adm-br1">
                    <div class="adm-rec_item" data-num="1">Department of Biological Science and Technology</div>
...
-->
            ...
            <div class="adm-block1">
                <div class="adm-block_r adm-br5">
                    <div class="adm-rec_item" data-num="5">Ph.D.  Program in Interdisciplinary Neuroscience </div>
                        <div class="adm-link adm-link_margin adm-text">Ph.D.<br>Program</div>
                </div>
                <div class="adm-text_block1 adm-text_block1_w text adm-tb5">The program intends to cultivate the talents with interdisciplinary knowledge on neuroscience and engineering. Its prospective students will do research on fundamental neuroscience, cognitive neuroscience, clinical neuroscience, and neuro-engineering. Students with backgrounds in electrical and computer engineering, computer science, engineering, life science, or clinical medicine are well encouraged to apply for admissions.</div>
                <a href="https://ustnc.ym.edu.tw//bin/home.php"><div class="adm_image_disappear read_more adm-ti5"></div></a>
            </div>
        ...
        <div class="adm-container adm-container1">
 	    ...
 	    <div class="adm-line"></div>
            ...
            <div class="adm-block-container formobile">
                ...
                <div class="adm-block1">
                    <a class="adm-rec_item" target="_blank" href="http://imols.nctu.edu.tw/admiss/super_pages.php?ID=imolsadmiss3">
         ...
         <div class="adm-block-container mobilehidden">   
            ...
            <div class="adm-block2 adm-b2-5">
                <div class="adm-block2-link">
                    <a target="_blank" href="http://imols.nctu.edu.tw/admiss/super_pages.php?ID=imolsadmiss3">
                        <div class="adm-link2 adm-link2_margin text">招生訊息</div>
                    </a>
                    <a target="_blank" href="http://imols.nctu.edu.tw/admiss/super_pages.php?ID=imolsadmiss3">
                        <div class="adm-link2 text">課程修業</div>
...
<!--	<div class= "adm-mobile_info adm-mobile_info0 formobile">
		...
		<div class="adm-mobile_info_line"></div>
                <a target="_blank" href="http://exam.nctu.edu.tw/bulletin.aspx?id=BF4FE8DE-60AB-4AB0-ADC6-0559AE2CFC76&id2=57eeeed7-2c9d-441f-b4f2-bf317e33ff41">
                        <p class="text adm-mobile_text adm-bottom_text2">繁星推薦</p>
                </a>
		<div class="adm-mobile_info_line"></div>
                <a target="_blank" href="http://exam.nctu.edu.tw/bulletin.aspx?id=BF4FE8DE-60AB-4AB0-ADC6-0559AE2CFC76&id2=7625f197-0399-482b-a569-8d0b6f87a3d7">
                        <p class="text adm-mobile_text adm-bottom_text3">考試分發</p>
                </a>
	    </div>
	</div>-->
		...
		<div class="adm-mobile_info_line"></div>
                <a target="_blank" href="http://exam.nctu.edu.tw/bulletin.aspx?id=af576c6a-ff5a-42ff-9278-5c5f6391d480&id2=f2a7e67a-4378-4e29-8b99-ab56bb451ac7">
                        <p class="text adm-mobile_text adm-bottom_text5">考試入學</p>
                </a>
            </div>
        </div>
...
<script>
	...
	$('.adm-mobile_info'+now).show();
        ...
        $(".adm_ti"  + new_num1).css({opacity: 0,display: 'inline-block'}).animate({opacity:1},600);
        old_num1 = new_num1;
        //initial pop up
        new_num2 = 1;
        ...
        $(".adm-rec_item").click(function(){
            ...
            if(new_num1 != old_num1){
                if(old_num1 != "0"){
                    ...
                    $( ".adm-ti" + old_num1 ).addClass("adm_image_disappear");
                }
                $( ".adm-br" + new_num1 ).removeClass("adm-block_r").addClass("adm-block_extend");
                if(new_num1 == "1"){
                    $( ".adm-br" + new_num1 ).addClass("adm-block_r_extend");
                ...
                $( ".adm-tb" + new_num1 ).fadeIn(1000);
                $( ".adm-ti" + new_num1 ).removeClass("adm_image_disappear");
                $(".adm_ti"  + new_num1).css({opacity: 0,display: 'inline-block'}).animate({opacity:1},600);
                old_num1 = new_num1;
            }else{
                ...
                $( ".adm-ti" + new_num1 ).addClass("adm_image_disappear");
                old_num1 = 0;
            }    
        });
