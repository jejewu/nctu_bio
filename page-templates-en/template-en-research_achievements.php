...
<div class="page-research_achievements">
    <div class="container">    
        ...
        <div class="ra-block">
            <p class="subtitled ra-title1 formobile">Research Focuses</p>
                <p class="subtitled ra-title1 mobilehidden">Research Focuses</p>
            ...
            <?php
                ...
                $args = array(
                        'category_name' => 'en-research_achievements',
                        'order'   => 'ASC',
                );
