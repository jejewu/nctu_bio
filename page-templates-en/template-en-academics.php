    ...
    <div class="container">
        <div id="ac-container">
            <div class="ac-title_block">
                <div class="subtitled rc-smalltitle mobilehidden">Academics</div>
                <div class="subtitle rc-bigtitle mobilehidden">Introduction to the Departments / Institutions</div>
                <div class="rc-smalltitle formobile">Academics</div>
                <div class="rc-bigtitle formobile">Introduction to the Departments / Institutions</div>
