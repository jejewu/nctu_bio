...
<div class="section <?php WPFP_Query()->get_section_easing(); ?> <?php WPFP_Query()->auto_height(); ?> <?php print WPFP_Query()->section->post_name; ?>" data-bg="<?php print WPFP_Query()->get_section_bg(); ?>">
