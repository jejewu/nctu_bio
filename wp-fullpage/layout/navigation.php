		...
		<ul>
			<?php 
				...
				?>
					...
					<li class="tooltipped" data-menuanchor="<?php print $section->post_name ?>" data-tooltip="<?php print esc_html( WPFP_Query()->get_section_nav_title( $key ) ); ?>" data-position="<?php print $position === 'left' ? 'right' : 'left' ; ?>">
